                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn" data-bs-toggle="modal"
                                                    ...
                                                    style="background: rgba(233, 25, 25, 0.14); border-radius: 3px; width: 100px;">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"
                                                style="color: #23AA44; margin-left:34%;">Terima Pesanan</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn"
                                                style="display: flex; flex-direction: row; justify-content: center; align-items: center; width: 219px; background: #121814; border-radius: 10px; color: whitesmoke; height: 60px; ">Terima
                                                Pesanan</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"
                                                style="color: #EC1C24; margin-left:34%;">Tolak Pesanan</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body" style="text-align: center;">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn"
                                                ...
                                                data-bs-dismiss="modal">Urungkan</button>
                                            <button type="button" class="btn"
                                                style="display: flex; flex-direction: row; justify-content: center; align-items: center; width: 219px; background: #121814; border-radius: 10px; color: whitesmoke; height: 60px; ">Tolak
                                                Pesanan</button>
                                        </div>
                                    </div>
                                </div>
